// ------------------- Products -------------------
const products = [
  {id:1,name:"Jute bear hug ",category:"collectible",price:399,description:"Bear requires a hug and you ?",image:"./res/Fruits/Apple.jpg"},
  {id:2,name:"cutie panda ",category:"collectible", price:499,description:"Strawberries with panda wanna have some...",image:"./res/Vegetables/carrot.jpeg"},
  {id:3,name:"Squeaky rat",category:"collectible", price:450,description:"flower for the SUN",image:"./res/Fruits/banana.jpg"},
  {id:4,name:"Sneaky penguin ",category:"collectible", price:499,description:"wanna have feast with the harvest",image:"./res/Vegetables/tomato.jpg"},
  {id:5,name:"Bunny hop",category:"collectible",price:350,description:"carrots and rabbit ..",image:"./res/Fruits/pears.jpeg"},
  {id:6,name:"Bunny junior",category:"collectible",price:350,description:"maybe in a different colour",image:"./res/Fruits/straw.jpeg"},
  {id:7,name:"Barky doggie",category:"fruits",price:579,description:"adoarable puppy with a flower basket",image:"./res/Fruits/jack.jpeg"},
